...
**Edited, 11/2/2025**: A point I forgot to add - in my last review, I noted Live Captions had a tendency to fall behind the audio on longer videos (~20 minutes or more). Apple fixed the issue at some point in early 2025; I haven't seen it happen for a good while now and it isn't a problem in Tahoe.
